...
function newViewportSize(genome_length){
    ...
    svg_div.style.width = Math.floor(window.innerWidth * 0.85) + "px"
    svg_div.style.height = Math.floor(window.innerHeight * 1) + "px"
}
...
function renderAll(calc, ans, clickmode=false){
    var seq = calc.genome;
